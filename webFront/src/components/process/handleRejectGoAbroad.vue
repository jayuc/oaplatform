    ...
    >
        <el-form :model="formData" ref="formData" :rules="rules">
            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="停留时间：" prop="days" :label-width="formLabelWidth">
                        <el-input style="width: 170px;" v-model.number="formData.days" autocomplete="off"></el-input>
                        天
                    </el-form-item>
                </el-col>
            </el-row>
