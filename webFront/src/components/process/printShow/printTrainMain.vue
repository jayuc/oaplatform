...
<template>
    ...
    >
        <div ref="tableContainer">
            <div id="tableContainer" style="position: relative;height: 740px;">
                ...
                <table border="1" cellspacing="0" align="center"
                    ...
                    <caption align="top" style="position: relative;">
                        <h2 style="font-size:18px;">合肥市烟草专卖局（公司）<br/>培 训 申 请 表</h2>
                        <span style="position: absolute;right: 40px;top: 50px;">HFYC-JL/RS-02</span>
                    </caption>
                    <tr height="65">
