                ...
                <table border="1" cellspacing="0" align="center"
                   ...
                   color:#333;font-size:13px;border-collapse:collapse;width:100%;position: absolute;left: 0;top: 0;z-index: 100;">
                    <caption align="top" style="position: relative;">
                        <h2 style="font-size:18px;">合肥市烟草专卖局（公司）<br/>出差审批单</h2>
                        <span style="position: absolute;right: 40px;top: 50px;">HFYC-JL/BG-93</span>
                    </caption>
                    <tr height="65">
                    ...
                    <tr height="65">
                        <th colspan="1">出差事由</th>
                        <td colspan="23">{{item.content}}</td>
                    </tr>
                    <tr height="65">
                        <th colspan="1">出差人员</th>
                        <td colspan="1">{{item.peopleList}}</td>
                        <th colspan="1">人数</th>
                        <td colspan="1">{{item.peopleNumber}}人</td>
                    </tr>
                    <tr height="65">
                        <th colspan="1">出差目的地</th>
                        <td colspan="1">{{item.address}}</td>
                        <th colspan="1">预计出差时间</th>
