    ...
    export default {
        ...
        methods: {
            ...
            open(data, url){
                ...
                if(data.startTime){
                    this.formData.useTime = data.startTime;
                    this.formData.sTime = data.startTime.split(' ')[1].substring(0,5);
                }
                if(data.endTime){
                    this.formData.eTime = data.endTime.split(' ')[1].substring(0,5);
                }
                this.url = url;
            },
            close(){
